    ...
    <div class="main2">
        ...
        <form class="container" action="" method="POST">
            <h3>CSS</h3>
                <div class="question1">
                <?php
                    $sql = "SELECT * FROM css_q WHERE Id=1";
                ...
                <div class="question1">
                <?php
                    $a = "SELECT * FROM css_q WHERE Id=2";
                ...
                <div class="question1">
                <?php
                    $b = "SELECT * FROM css_q WHERE Id=3";
                ...
                <div class="question1">
                <?php
                    $c = "SELECT * FROM css_q WHERE Id=4";
                ...
                <div class="question1">
                <?php
                    $d = "SELECT * FROM css_q WHERE Id=5";
                ...
                <div class="coloum2">
                    <div class="question1">
                    <?php
                    $e = "SELECT * FROM css_q WHERE Id=6";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $f = "SELECT * FROM css_q WHERE Id=7";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $g = "SELECT * FROM css_q WHERE Id=8";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $h = "SELECT * FROM css_q WHERE Id=9";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $i = "SELECT * FROM css_q WHERE Id=10";
