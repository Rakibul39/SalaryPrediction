        ...
        <form class="container" action="" method="POST">
            <h3>CSS</h3>
                <div class="question1">
                    ...
                    <input type="radio"  name="q1" id="dot-1" value="0" >Canvas Shift Style
                    <input type="radio" name="q1" id="dot-2" value="1">Cascade Style Sheet
                </div>

                <div class="question1">
                    <p>Is Bootstrap a framework or not?</p>
                    <input type="radio" name="q2" id="dot-1" value="1">Yes
                    <input type="radio" name="q2" id="dot-2" value="0">No
                </div>

                <div class="question1">
                    <p>Are you familiar with hover effect in CSS?</p>
                    <input type="radio" name="q3" id="dot-1" value="1">Yes
                    <input type="radio" name="q3" id="dot-2" value="0">No 
                </div>

                <div class="question1">
                    <p>Can you use same image two times in same html page as background image?</p>
                    <input type="radio" name="q4" id="dot-1" value="1">Yes
                    <input type="radio" name="q4" id="dot-2" value="0">No 
                </div>

                <div class="question1">
                    <p>Do you know how to make a html page responsive?</p>
    ...
    //CHeck whether the button is clicked or not
        if(isset($_POST['submit']))
        {
            ...
            $sql2 = "SELECT user_id FROM language_point WHERE user_id = '$user_id' ";
               ...
               if($count2>0){
                   echo "already added";
                   $sql3="UPDATE language_point SET css='$qx' WHERE user_id='$user_id' ";
                   $res3 = mysqli_query($con, $sql3);
                   echo"<script> window.open('languages.php','_self')</script>";
                 }
               else{
                   $sql4="INSERT INTO `language_point`(`user_id`, `css`) VALUES('$user_id','$qx')";
