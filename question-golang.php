        ...
        <form class="container" action="" method="POST">
            <h3>GoLang</h3>
                ...
                <div class="coloum2">
                    ...
                    <div class="question1">
                        <p>Do you develop any project using Golang?</p>
    ...
    //CHeck whether the button is clicked or not
        if(isset($_POST['submit']))
        {
            ...
            $sql2 = "SELECT user_id FROM language_point WHERE user_id = '$user_id' ";
               ...
               if($count2>0){
                   echo "already added";
                   $sql3="UPDATE language_point SET golang='$qx' WHERE user_id='$user_id' ";
                   $res3 = mysqli_query($con, $sql3);
                   echo"<script> window.open('languages.php','_self')</script>";
                 }
               else{
                   $sql4="INSERT INTO `language_point`(`user_id`, `golang`) VALUES('$user_id','$qx')";
