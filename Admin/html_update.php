...
<p>HTML-Question</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM html_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            {
                                                //Redirect to 
                                                header('location:'.SITEURL.'admin/html_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('html_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
