...
<p>Python-Questions</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM python_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            {
                                                header('location:'.SITEURL.'admin/python_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('python_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
