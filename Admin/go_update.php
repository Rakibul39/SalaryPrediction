...
<p>GoLang-Question</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM golang_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            else
                                            {
                                                ...
                                                header('location:'.SITEURL.'admin/go_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('go_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
