...
<p>CSS-Questions</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                //SQL Query to Get the Selected question
                                                $sql2 = "SELECT * FROM css_q WHERE Id=$id";
                                                //execute the Query
                                                ...
                                                //Get the Individual Values of Selected question
                                            ...
                                            {
                                                header('location:'.SITEURL.'admin/css_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('css_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
