...
<p>C#-Question</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM csharp_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            else
                                            {
                                                ...
                                                header('location:'.SITEURL.'admin/csharp_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('csharp_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
