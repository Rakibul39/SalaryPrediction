...
<p>Swift-Questions</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM swift_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            {
                                                header('location:'.SITEURL.'admin/swift_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('swift_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
