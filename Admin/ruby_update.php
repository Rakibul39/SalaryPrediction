...
<p>Ruby-Question</p>
                                    <?php 
                                            ...
                                            if(isset($_GET['id']))
                                            {
                                                ...
                                                $sql2 = "SELECT * FROM ruby_q WHERE Id=$id";
                                                //execute the Query
                                            ...
                                            {
                                                header('location:'.SITEURL.'admin/ruby_question.php');
                                            }
                                     ?>
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($res3==true)
                                                {
                                                    ...
                                                    echo "<script>window.open('ruby_question.php','_self')</script>";
                                                    <?php
                                                }
                                                else
                                                {
