...
?>
    ...
    <div class="main2">
        ...
        <form class="container" action="" method="POST">
            ...
            <div class="question1">
                <?php
                    $sql = "SELECT * FROM python_q WHERE Id=1";
                ...
                <div class="question1">
                <?php
                    $a = "SELECT * FROM python_q WHERE Id=2";
                ...
                <div class="question1">
                <?php
                    $b = "SELECT * FROM python_q WHERE Id=3";
                ...
                <div class="question1">
                <?php
                    $c = "SELECT * FROM python_q WHERE Id=4";
                ...
                <div class="question1">
                <?php
                    $d = "SELECT * FROM python_q WHERE Id=5";
                ...
                <div class="coloum2">
                    <div class="question1">
                    <?php
                    $e = "SELECT * FROM python_q WHERE Id=6";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $f = "SELECT * FROM python_q WHERE Id=7";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $g = "SELECT * FROM python_q WHERE Id=8";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $h = "SELECT * FROM python_q WHERE Id=9";
                ...
                ?>
                    ...
                    <div class="question1">
                    <?php
                    $i = "SELECT * FROM python_q WHERE Id=10";
...
//CHeck whether the button is clicked or not
        if(isset($_POST['submit']))
        {
            ...
            $sql2 = "SELECT user_id FROM language_point WHERE user_id = '$user_id' ";
               ...
               if($count2>0){
                   echo "already added";
                   $sql3="UPDATE language_point SET python='$qx' WHERE user_id='$user_id' ";
                   $res3 = mysqli_query($con, $sql3);
                   echo"<script> window.open('languages.php','_self')</script>";
                 }
               else{
                   $sql4="INSERT INTO `language_point`(`user_id`, `python`) VALUES('$user_id','$qx')";
